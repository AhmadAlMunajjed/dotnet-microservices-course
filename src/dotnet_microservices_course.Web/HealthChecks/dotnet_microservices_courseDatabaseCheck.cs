...
public class dotnet_microservices_courseDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public dotnet_microservices_courseDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
