...
public class dotnet_microservices_courseEntityFrameworkCoreModule : AbpModule
{
    ...
    {
        context.Services.AddAbpDbContext<dotnet_microservices_courseDbContext>(options =>
        {
        ...
        Configure<AbpDbContextOptions>(options =>
        {
             ...
             * See also dotnet_microservices_courseDbContextFactory for EF Core tooling. */
