...
namespace dotnet_microservices_course.Migrations
{
    ...
    [Migration("20251020024508_OrdersProducts")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dotnet_microservices_course.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("dotnet_microservices_course.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("dotnet_microservices_course.Orders.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("dotnet_microservices_course.Orders.OrderItem", b =>
                {
                    b.HasOne("dotnet_microservices_course.Orders.Order", "Order")
                        .WithMany("Items")
